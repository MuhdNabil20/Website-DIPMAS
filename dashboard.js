...
document.getElementById('toggleMock').addEventListener('click', ()=>{
  mockMode = !mockMode;
  toggleMockBtn.textContent = mockMode ? 'Disable Mock' : 'Toggle Mock';
  showToast(`Mock ${mockMode ? 'enabled' : 'disabled'}`);
});
